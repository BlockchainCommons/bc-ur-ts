...
// The encoders are infinite by design: break out of `for … of` when done,
// or take a prefix with the iterator helpers (Node >= 22).
const three = encoder[Symbol.iterator]().take(3);
```
